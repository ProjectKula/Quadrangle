...
<div
  class="w-60 flex flex-col flex-shrink text-sm bg-neutral-200 dark:bg-neutral-800 border-l border-neutral-300 dark:border-black px-1 max-md:hidden items-center h-screen">
  <div class="contents text-neutral-500">
    <h5 class="mb-4 mt-1">{copyrightText}</h5>
